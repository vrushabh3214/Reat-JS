        ...
        <>
            ...
            {/* <div id="default-carousel" className="relative w-full" data-carousel="slide">
                ...
                <div className="relative h-56 rounded-lg md:h-96">
                    ...
                    <!-- Item 2 -->
                    <div className=" duration-700 ease-in-out" data-carousel-item>
                        <img src="https://www.sportico.com/wp-content/uploads/2020/09/0911_IMG.jpg" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" width="100px" alt="..."/>
                    </div>
                    <!-- Item 3 -->
                    <div className=" duration-700 ease-in-out" data-carousel-item>
